...
my %tags = (	"<capitulo>" => "\\newpage \\chapter{",
                ...
                "<comando>" => "\\vspace{-5pt}\\begin{BoxVerbatim}",
                "</comando>" =>	"\\end{BoxVerbatim}",
                "<comandoNumerado>" => "\\vspace{-5pt}\\begin{VerbatimNumerado}",
                ...
                "<math>" => "\$",
                "</math>" => "\$",
                "<icon>" => "\\includegraphics[width=0.3cm, height=0.3cm]{",
                "</icon>" => "}",
                "<eye/>" => "\\includegraphics[width=0.3cm, height=0.3cm]{imgs/icon-eye.png}",
                "<gear/>" => "\\includegraphics[width=0.3cm, height=0.3cm]{imgs/icon-gear.png}",
